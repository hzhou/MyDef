            ...
            if($val_type){
                if(!$type){
                    ...
                    if($type ne $val_type){
                        ...
                        elsif($val_type eq "float" and $type=~/double/){
                        }
                        elsif($val_type eq "char" and $type=~/unsigned|int/){
                        }
                        elsif($val_type eq "int" and $type=~/(double|float|bool|int)/){
                        }
